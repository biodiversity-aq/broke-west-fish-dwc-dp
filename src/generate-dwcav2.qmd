...
material <- material %>% select(materialEntityID, materialGatheringID, materialEntityType, derivedFromMaterialEntityID, derivationType, partOfMaterialEntityID, preparations, disposition, materialEntityRemarks)
