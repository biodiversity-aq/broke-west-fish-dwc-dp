...
# electrona antarctica BROKE_WEST_RMT_037_RMT8

# total catch of Pleuragramma antarcticum from BROKE_WEST_RMT_022_RMT8
occurrence %>% filter(eventID == "BROKE_WEST_RMT_037_RMT8" & taxonID == "urn:lsid:marinespecies.org:taxname:234721")

# all preserved Pleuragramma antarcticum from BROKE_WEST_RMT_022_RMT8
material %>% filter(eventID == "BROKE_WEST_RMT_022_RMT8" & taxonID == "urn:lsid:marinespecies.org:taxname:234721")
